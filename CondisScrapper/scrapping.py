...
for product_data in product_data_list:
    print('Título:', product_data['title'])
    print('Precio:', product_data['price'])
    print('Precio por kilo/litro:', product_data['price_per_unit'])
    print('Imagen:', product_data['image_url'])
    print('---')
